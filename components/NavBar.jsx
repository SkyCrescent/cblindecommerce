...
//    const isInfosPage = pathname.includes("/infos")  || pathname.includes("/login");
    ...
    return (
        <nav className="relative w-[80%] mx-auto  flex flex-row text-md justify-between gap-3 items-center">
            {/* Logo */}
            ...
            {/* Menu */}
            <div className="relative w-[60%] my-9 -mx-9 md:w-[50%] lg:w-[30%] flex flex-col font-bold md:mx-1">
                <div className="hidden md:block">
                    <ul className="lg:px-1 m-8 md:m-3 lg:m-1 flex justify-between items-center flex-row gap-6 md:gap-2 lg:gap-1">
                        ...
                        {/* Affiche le lien "Retour" si on est sur infos */}
                                ...
                                <li className="text-blue-900 transition duration-300 transform hover:scale-105">
                                    <Link href="/admin/home">Produits</Link>
                                </li>
                                <li className="text-blue-900 transition duration-300 transform hover:scale-105">
                                    <Link href="/admin/List">Catalogues</Link>
                                </li>
