   ...
   // const { id } = useParams();
    ...
    const inputFields = [
        ...
        { id: 2, name: "details", type: "text", label: "Description", value: values.details },
         { id: 3, name: "prix", type: "text", label: "prix", value: values.prix },
    ];
            ...
            if (allowedExtensions.includes(fileExtension)) {
                ...
                try {
                    ...
                    setValues((prevValues) => ({
                        ...prevValues,
                        photo: `media/service/${selectedFile1.name}`,
                    }));
    ...
    const handleSubmit = async () => {
        ...
        if (!values.details.trim()) {
            newErrors.details = "Detail requise";
        }
        if (!values.prix.trim()) {
                newErrors.prix = "prix requise";
            }
        ...
        try {
            ...
            const response = await axios.post(`${apiUrl}/updateService`, {
              id: id,
                nom: values.nom,
           ...
           // console.log("✔ Produit ajouté :", response.data);
            ...
            setDialog({
                open: true,
                message: "Service Modifie avec succès 🎉",
                type: "success"
            });
    ...
    const getInfos = async (id) => {
        try {
            setLoading(true);
            const response = await axios.post(`${apiUrl}/getInfosService`, { id });
