...
export default function AdminCatalogue() {
    ...
    const input = [
        { id: 1, name: "username", type: "text", placeholder: "Nom",value: values.username   ,label: "Entrez votre le nom du catalogue", className: `text-xl w-[90%] text-gray-700 bg-white/75 border rounded-lg border-gray-300 py-2 px-10 h-14 focus:outline-none focus:border-blue-500 `,
    ...
    const supprimerProduit = async (id) => {
        ...
        try {
            ...
            const response = await axios.post(`${apiUrl}/deleteService`, {id});
    ...
    const modifierProduit = (id) => {
        router.push(`/admin/service/updatecatalogue?id=${encodeURIComponent(btoa(id))}`);
    };
    ...
    return (
        <div className="relative min-h-screen bg-white p-6">
            ...
            <div className="relative z-20 flex justify-between items-center mb-8">
                <h1 className="text-3xl font-bold text-blue-700">Gestion des services </h1>
                ...
                {catalogue .filter((p) =>
                    ...
                    >
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-sm text-gray-500 truncate">Prix : {item.prix}  FCFA</p>
                        </div>
            ...
            {dialog && (
                <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
                    <div className="bg-white rounded-xl shadow-lg p-6 w-[350px] text-center">
                        ...
                        <p className="text-gray-700 mb-4">Voulez vous supprimer ce service ??</p>
